...
export class MedicinesService {
  ...
  //search by Medicine 
  searchMedicines(name: string): Observable<any> {
    ...
    return this.http.get("http://localhost:9797/medicine/findByName/"+name,
    {  headers: headers1, observe: "response"} ); 
    */

    return this.http.get("http://localhost:9797/medicine/findByName/",
      { params: { input: name } }
    );
